...
class MyTestCase(unittest.TestCase):
    ...
    def test_frequencies(self):
        ...
        time.sleep(2)
        self.assertListEqual(self.out.lines[:-1], open('../test/wordCount', 'r').readlines()[:-1], self.out.lines)
    ...
    def test_countwords(self):
        ...
        time.sleep(2)
        self.assertListEqual(self.out.lines[:-1], open('../test/count', 'r').readlines()[:-1], self.out.lines)
